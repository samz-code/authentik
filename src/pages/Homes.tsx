        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-[#194C4C]/70 leading-relaxed">
              Premium property hosting and management for owners who want peace of mind, care, and consistent income.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 max-w-6xl mx-auto">
            {[
              ...
              <div
                key={stat.label}
                className="bg-white rounded-2xl p-6 text-center shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border-2 border-[#DADFDB]"
                style={{
              ...
              >
                ...
                <p className="text-3xl md:text-4xl font-bold text-[#194C4C] mb-2">{stat.value}</p>
                <p className="text-sm md:text-base text-[#194C4C]/60 font-medium">{stat.label}</p>
              </div>
            ))}
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl" style={{ opacity: 0, animation: 'fadeInUp 0.6s ease-out forwards' }}>
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  <p className="text-white font-serif text-2xl md:text-3xl italic">"Premium hosting, exceptional care"</p>
                </div>
              </div>
              ...
              <div style={{ opacity: 0, animation: 'fadeInUp 0.6s 0.2s ease-out forwards' }}>
                ...
                <div className="space-y-4 text-base md:text-lg text-[#194C4C]/80 leading-relaxed">
                  <p className="flex items-start gap-3">
                    <i className="fas fa-times-circle text-red-500 text-xl mt-1 flex-shrink-0"></i>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
            {services.map((service, index) => (
              ...
              >
                ...
                <h3 className="font-serif text-xl md:text-2xl font-semibold text-[#194C4C] mb-4 group-hover:text-[#3A9387] transition-colors">
                  {service.title}
                </h3>
            ...
            <div className="bg-gradient-to-br from-[#F79120] to-[#E17C47] rounded-2xl p-8 text-white shadow-xl flex flex-col justify-center items-center text-center transform hover:scale-105 transition-all duration-300">
              <i className="fas fa-plus-circle text-5xl md:text-6xl mb-6 opacity-90"></i>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-6xl mx-auto">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl group">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#194C4C]/80 to-transparent flex items-end p-8">
                <div>
                  <p className="text-white font-serif text-2xl md:text-3xl mb-2">Professional Interiors</p>
                  <p className="text-white/80 text-base">Designed for maximum appeal</p>
                </div>
              </div>
            </div>
            <div className="relative rounded-3xl overflow-hidden shadow-2xl group">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#194C4C]/80 to-transparent flex items-end p-8">
                <div>
                  <p className="text-white font-serif text-2xl md:text-3xl mb-2">Prime Locations</p>
                  <p className="text-white/80 text-base">Beachfront to city center</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 max-w-6xl mx-auto">
            {outcomes.map((outcome, index) => {
              ...
              return (
                <div
                  key={outcome.title}
                  className="bg-white rounded-2xl p-8 text-center shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border-2 border-transparent hover:border-[#3A9387]"
                  style={{
                    animationDelay: `${index * 0.1}s`,
                    opacity: 0,
                    animation: 'fadeInUp 0.6s ease-out forwards'
                ...
                >
                  <div className="w-16 h-16 bg-[#DADFDB] rounded-full flex items-center justify-center mx-auto mb-6 transform hover:scale-110 hover:rotate-6 transition-all duration-300">
                    <Icon className="w-8 h-8 text-[#3A9387]" />
                  </div>
                  <h3 className="font-serif text-lg md:text-xl font-semibold text-[#194C4C] mb-3">
                    {outcome.title}
                  </h3>
                  <p className="text-sm md:text-base text-[#194C4C]/70">
                    {outcome.description}
                  </p>
                </div>
              );
      ...
      <SectionWrapper background="neutral">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-3xl p-8 md:p-12 lg:p-16 shadow-2xl border-2 border-[#DADFDB]">
              ...
              <div className="bg-[#DADFDB]/50 rounded-2xl p-8 md:p-10 mb-10">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {pricingFactors.map((factor, index) => (
                    <div key={index} className="flex items-center gap-3">
                      ...
                      <span className="text-base text-[#194C4C]/80">{factor}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="text-center">
                <p className="text-lg md:text-xl text-[#194C4C] mb-8">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group bg-white rounded-2xl p-8 shadow-md hover:shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-[#3A9387] transform hover:-translate-y-2"
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-4 mb-4">
                      <div className="w-14 h-14 bg-[#DADFDB] rounded-2xl flex items-center justify-center">
                        <i className="fas fa-award text-2xl text-[#3A9387]"></i>
                      </div>
                      <div>
                        <p className="font-serif text-xl md:text-2xl font-semibold text-[#194C4C] group-hover:text-[#3A9387] transition-colors">
                          Airbnb Superhost
                        </p>
